...
import static com.server.core.constants.CommonConstants.COMMA;
import static com.server.core.constants.CommonConstants.SQL_QUERY;
import static com.server.core.util.DatabaseUtil.executeCreateQuery;
import static com.server.core.util.DatabaseUtil.executeFetchQuery;
import static com.server.core.util.DatabaseUtil.executeUpdateQuery;

/**
 * @author Kazi Tanvir Azad
 * @apiNote This class has database repository methods for performing all SQL queries
 * <br>for {@link com.server.core.model.data.Server} restart settings during application startup
 */
