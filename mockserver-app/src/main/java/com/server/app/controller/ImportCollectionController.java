...
import static com.server.app.constants.AppConstants.LIGHT_GREEN_COLOR_HEX_CODE;
import static com.server.app.constants.AppConstants.LIGHT_GREY_COLOR_HEX_CODE;
import static com.server.app.constants.AppConstants.LIGHT_RED_COLOR_HEX_CODE;
...
import static com.server.core.constants.CommonConstants.IMPORT_FILE_PATH_DEFAULT_TEXT;
import static com.server.core.constants.CommonConstants.IMPORT_FILE_SELECTOR_TITLE;
import static com.server.core.constants.CommonConstants.JSON_FILE_EXTENSION;
    ...
    private void handleImportCollectionButton(ActionEvent event) {
        if (!FileUtils.isRegularFile(selectedFile)) {
            CommonConfig.INSTANCE.notification()
                    .triggerErrorNotification("Invalid file selection", "Select a valid file to continue");
            return;
        }
